...
const cross = document.getElementsByClassName('cross')[0];
    ...
    if ((res==='121112')||(res ==='121113')||(res === '121211')||(res==='121212')||(res==='121213')||(res==='121311')||(res==='121312')||(res==='121313')||(res==='121313')||(res==='121313')||(res==='122111')||(res==='122112')||(res==='122113')||(res==='122312')||(res==='122211')||(res==='122212')||(res==='122213')||(res==='122313')||(res==='123111')||(res==='123112')||(res==='123112')||(res==='123113')||(res==='123211')||(res==='123212')||(res==='123213')||(res==='123311')||(res==='123312')||(res==='123313')||(res==='131111')||(res==='131112')||(res==='131121')||(res==='131121')||(res==='131122')||(res==='131122')||(res==='131211')||(res==='131212')||(res==='131221')||(res==='131222')||(res==='131311')||(res==='131311')||(res==='131312')||(res==='131312')||(res==='131321')||(res==='131322')||(res==='132111')||(res==='132112')||(res==='132121')||(res==='132122')||(res==='132211')||(res==='132211')||(res==='132212')||(res==='132221')||(res==='132222')||(res==='132311')||(res==='132312')||(res==='132321')||(res==='133111')||(res==='133112')||(res==='133121')||(res==='133122')||(res==='133211')||(res==='133212')||(res==='133221')||(res==='133312')||(res==='133321')||(res==='133322')||(res==='133311')||(res==='133222')) {                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           "", "", "", "", "", "", "", "", "", "", "",                                                                                                                                  "", "", "", "", "", "",                                         
          document.querySelector('#finalresult__title span').innerHTML = 'first outcome';
    }
     // second outcome
     ...
     // third outcome
        ...
        document.querySelector('#finalresult__title span').innerHTML = 'third outcome';
        // document.getElementById('result').style.backgroundImage = "url('https://images.riverisland.com/is/image/RiverIsland/792382_main?wid=1200')";
     }
    // fourth outcome
        ...
        document.querySelector('#finalresult__title span').innerHTML= 'fourth outcome';
        // document.getElementById('result').style.backgroundImage = "url('https://images.riverisland.com/is/image/RiverIsland/792382_main?wid=1200')";
     }
      // fifth outcome
        ...
        document.querySelector('#finalresult__title span').innerHTML = 'fifth outcome';
        // document.getElementById('result').style.backgroundImage = "url('https://images.riverisland.com/is/image/RiverIsland/792382_main?wid=1200')";
     }
      // sixth outcome
        ...
        document.querySelector('#finalresult__title span').innerHTML = 'sixth outcome';
        // document.getElementById('result').style.backgroundImage = "url('https://images.riverisland.com/is/image/RiverIsland/792382_main?wid=1200')";
     }
        // seventh outcome
        ...
        document.querySelector('#finalresult__title span').innerHTML = 'seventh outcome';
        // document.getElementById('result').style.backgroundImage = "url('https://images.riverisland.com/is/image/RiverIsland/792382_main?wid=1200')";
     }
         // eight outcome
        ...
        document.querySelector('#finalresult__title span').innerHTML = 'eight outcome';
        // document.getElementById('result').style.backgroundImage = "url('https://images.riverisland.com/is/image/RiverIsland/792382_main?wid=1200')";
     }
        // ninth outcome
        ...
        document.querySelector('#finalresult__title span').innerHTML = 'ninth outcome';
            // document.getElementById('result').style.backgroundImage = "url('https://images.riverisland.com/is/image/RiverIsland/792382_main?wid=1200')";
    }
    // tenth outcome
        ...
        document.querySelector('#finalresult__title span').innerHTML = 'tenth outcome';
           // document.getElementById('result').style.backgroundImage = "url('https://images.riverisland.com/is/image/RiverIsland/792382_main?wid=1200')";
   }
    // eleventh outcome
        ...
        document.querySelector('#finalresult__title span').innerHTML = 'eleventh outcome';
           // document.getElementById('result').style.backgroundImage = "url('https://images.riverisland.com/is/image/RiverIsland/792382_main?wid=1200')";
   }
//    12th outcome
    else if ((res==='231111')||(res==='231112')||(res==='231113')||(res==='231211')||(res==='231212')||(res==='231213')||(res==='231311')||(res==='231312')||(res==='231313')||(res==='232111')||(res==='232112')||(res==='232113')||(res==='232211')||(res==='232212')||(res==='232213')||(res==='232311')||(res==='232312')||(res==='232313')||(res==='233111')||(res==='233112')||(res==='233113')||(res==='233211')||(res==='233212')||(res==='233213')||(res==='233311')||(res==='233312')||(res==='233313')) {
        document.querySelector('#finalresult__title span').innerHTML = '12th outcome';
        // document.getElementById('result').style.backgroundImage = "url('https://images.riverisland.com/is/image/RiverIsland/792382_main?wid=1200')";
    }
    // 13th outcome
        ...
        document.querySelector('#finalresult__title span').innerHTML = '13th outcome';
            // document.getElementById('result').style.backgroundImage = "url('https://images.riverisland.com/is/image/RiverIsland/792382_main?wid=1200')";
     }
  // 14th outcome 
        ...
        document.querySelector('#finalresult__title span').innerHTML= '14th outcome';
        // document.getElementById('result').style.backgroundImage = "url('https://images.riverisland.com/is/image/RiverIsland/792382_main?wid=1200')";
    }
  // 15th outcome 
        ...
        document.querySelector('#finalresult__title span').innerHTML = '15th outcome';
    }
     // 16th outcome 
        ...
        document.querySelector('#finalresult__title span').innerHTML = '16th outcome';
    }
    else {
        return;
    }
